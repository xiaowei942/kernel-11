...
#define RX8025_OPT_LOCK

#define HAVE_8025_DEV
...
#define KEYB_SET_BUF_CLR	_IO(KEYB_CFG_MAJOR, 0)
#define KEYB_IS_BUF_CLR		_IO(KEYB_CFG_MAJOR, 1)
#define KEYB_BEEP_OFF		_IO(KEYB_CFG_MAJOR, 2)
#define KEYB_BEEP_ON		_IO(KEYB_CFG_MAJOR, 3)
#define KEYB_BEEP_GET		_IO(KEYB_CFG_MAJOR, 4)
#define KEYB_PWRKEY_GET		_IO(KEYB_CFG_MAJOR, 5)
#define PWRKEY_DISABLE_A_SEC	_IO(KEYB_CFG_MAJOR, 6)
#define	PWRKEY_DISABLE		_IO(KEYB_CFG_MAJOR, 7)
#define	PWRKEY_ENABLE		_IO(KEYB_CFG_MAJOR, 8)
#define	KEYB_IRQ_DISABLE	_IO(KEYB_CFG_MAJOR, 9)
#define	KEYB_IRQ_ENABLE		_IO(KEYB_CFG_MAJOR, 10)
#define KEYB_BL_SAVE		_IO(KEYB_CFG_MAJOR, 11)
#define KEYB_BL_RESTORE		_IO(KEYB_CFG_MAJOR, 12)
#define PWRKEY_DISABLE_TEMP	_IO(KEYB_CFG_MAJOR, 13)
#define PWRKEY_INIT		_IO(KEYB_CFG_MAJOR, 14)
#define PWRKEY_TIMER_OFF	_IO(KEYB_CFG_MAJOR, 15)
#define KEYB_CHECK_VAL		_IO(KEYB_CFG_MAJOR, 16)
#define SCAN_KEY_VAL		_IO(KEYB_CFG_MAJOR, 17)
...
#define AT91_MAX7347_I2C_ADDRESS  (0x38<<16) /* max7347 addr: 0x38 */

#define AT91_RX8025_I2C_ADDRESS    (0x32<<16) /* r8025 addr: 0x32 */
#define RX8025_START_YEAR		1990
#define RX8025_END_YEAR			2089	


#ifdef __NEW_KB
#define KEY_IRQ_ID	AT91SAM9261_ID_IRQ2
#else
#define KEY_IRQ_ID	AT91SAM9261_ID_IRQ0
#endif

#define KEY_IRQ		(0x1 << KEY_IRQ_ID)

#define POWER_IRQ_ID	AT91SAM9261_ID_IRQ1
#define POWER_IRQ	(0x1 << POWER_IRQ_ID)

#define POWER_PIO	AT91_PIN_PB30

#define SCAN_KEY_ID	AT91_PIN_PA20


#define KEY_BL		AT91_PIN_PB4
#define KEY_BP		AT91_PIN_PB9
#define KEY_SHT		AT91_PIN_PB15
...
static int is_irq_disable = 0;

/* extended function: power key irq disable/enable */
#define PWR_IRQ_DISABLE()				\
	do{						\
		if (!is_irq_disable){			\
			is_irq_disable = 1;		\
