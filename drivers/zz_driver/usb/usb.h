...
typedef char (*S_usb_stall)(const S_usb   *pUsb,
                            unsigned char bEndpoint);
typedef int (*S_usb_halt)(const S_usb   *pUsb,
                           unsigned char bEndpoint,
                           unsigned char bRequest);
typedef void (*S_usb_remote_wakeup)(const S_usb *pUsb);
typedef int (*S_usb_cfg_endpoint)(const S_usb                     * pUsb,
                                   const S_usb_endpoint_descriptor *pEpDesc);
typedef int (*S_usb_attach)(const S_usb *);
...
struct _S_usb {
    ...
    S_usb_endpoint*   pEndpoints;     //!< Endpoints list
    unsigned int            dNumEndpoints;  //!< Number of endpoints in list
    S_usb_callbacks  *pCallbacks;     //!< Pointer to the callbacks
    S_usb_request*     pSetup;         //!< \brief Pointer to the last
                                            //!< received SETUP packet
    volatile unsigned int*  pState;    //!< Current state of the device
};
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern char USB_Write(const S_usb *pUsb,
                      unsigned char bEndpoint,
                      const void *pData,
                      unsigned int dLength,
                      Callback_f fCallback,
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern char USB_SendZLP0(const S_usb *pUsb,
                         Callback_f  fCallback,
                         void        *pArgument) ;
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern char USB_Read(const S_usb *pUsb,
                     unsigned char bEndpoint,
                     void *pData,
                     unsigned int dLength,
                     Callback_f fCallback,
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern char USB_Stall(const S_usb *pUsb, unsigned char bEndpoint);
//------------------------------------------------------------------------------
//! \ingroup usb_api_methods
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern void USB_RemoteWakeUp(const S_usb *pUsb);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern int USB_Halt(const S_usb   *pUsb,
                     unsigned char bEndpoint,
                     unsigned char bRequest);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern void USB_SetAddress(const S_usb *pUsb);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern void USB_SetConfiguration(const S_usb *pUsb);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern int USB_ConfigureEndpoint(const S_usb                     *pUsb,
                                  const S_usb_endpoint_descriptor *pEpDesc);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern void USB_Handler(const S_usb * pUsb);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern int USB_Attach(const S_usb *pUsb);
...
//! \see    USB_Disconnect
//------------------------------------------------------------------------------
extern void USB_Connect(const S_usb *pUsb);
...
//! \see    USB_Connect
//------------------------------------------------------------------------------
extern void USB_Disconnect(const S_usb *pUsb);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern void USB_Init(const S_usb *pUsb);
...
//! \see    S_usb
//------------------------------------------------------------------------------
extern unsigned int USB_GetState(const S_usb *pUsb);
