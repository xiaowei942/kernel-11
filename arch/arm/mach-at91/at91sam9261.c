...
{
	printk (KERN_ALERT"petworm: really shutdown.\n");
	at91_sys_write(AT91_SHDW_CR, AT91_SHDW_KEY | AT91_SHDW_SHDW);
	/* petworm add: stop the cpu last 2 SLCK cycle */
	while(1)
		printk ("fatal error: can't shutdown machine.\n");
}
...
static unsigned int at91sam9261_default_irq_priority[NR_AIC_IRQS] __initdata = {
	...
	0,
	0,
	7,	/* Advanced Interrupt Controller - MAX7347 key board controller */
